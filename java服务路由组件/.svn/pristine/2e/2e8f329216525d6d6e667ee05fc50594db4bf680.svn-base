...
import com.better517na.JavaServiceRouteHelper.business.thread.WriteServerAccLog;
import com.better517na.JavaServiceRouteHelper.business.thread.WriteServerSlowLog;
...
public class LogOperate {
     ...
     * 日志
     */
    private static Logger log = Logger.getLogger(LogOperate.class);
    ...
    public static void writeClientAccLog(MLogAcc acc, String serverIp) {
        ...
        LogOperate.writeAccLogSafe(acc);
    }
     ...
     *            clientIp
     */
    public static void writeServerAccLog(String requestStr, String responseStr, String clientIp) {
        ...
        mTrackID.setStartTime(mTrackID.getStartTime());

        // 最后耗时的 交给异步去处理
        WriteLogThreadPool.getBTaskThreadPool().loadTasks(new WriteServerAccLog(requestStr, responseStr, clientIp, asymodel, ThreadLocalLogAttach.getTimeStamp()));
    }
    ...
    public static void writeServerSlowLog(MLogSlowCall slowLog, AsyTrackIDModel asymodel) {
        ...
        LogOperate.writeSlowLogSafe(slowLog);
    }
     ...
     *            clientIp
     */
    public static void writeServerSlowLog(String requestStr, String invokeTime, String clientIp) {
        // 传输model
        AsyTrackIDModel asymodel = new AsyTrackIDModel();
        // 解析trackId
        MTrackID mTrackID = LogOperate.getTrackIdObj();
